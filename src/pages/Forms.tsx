...
const formModules = import.meta.glob("../components/forms/*.forms.tsx", {
  eager: true,
}) as Record<string, Record<string, React.ComponentType<unknown>>>;
  ...
  for (const [, module] of Object.entries(formModules)) {
    ...
    for (const [exportName, exportValue] of Object.entries(module)) {
      if (
        ...
        forms.push({
          name: exportName,
          component: exportValue as React.ComponentType<{
